...
import numpy as np
import pandas as pd
from utils.hand.api import (ffmpeg4format, hand_parameters,  # hand_pos_inference,
                            model_pred_severity, mp_kpts_generator,
...
def main_single(cfg):
    ...
    ffmpeg4format(video_path=video_output_path.replace(".mp4", "_annot.mp4"),
                  output_path=video_output_path.replace(".mp4", "_annot_.mp4"))  # encode to h264
